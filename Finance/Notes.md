...
Equation: \
$`
P_0 = \frac{Div_{t=1}}{(1+R)^1} + \frac{Div_{t=2}}{(1+R)^2} + \frac{Div_{t=3}}{(1+R)^3} + ... + \frac{Div_{t=\infty}}{(1+R)^\infty} = \frac{Div}{R}
`$ 
...
Just paid dividend = $`Div_0`$ = $0.50 \
Growth of dividend per year = $`g`$ = 2% \
Return on capital = $`R`$ = 15% 

Hence selling price of the stock = $`P_0 = \frac{Div_0(1+g)}{R-g} = \frac{0.50 \times (1+0.02)}{0.15 - 0.02}`$ = $3.92
